...
var Levels = []Level{
	...
	// —— 第六章 · 绝处逢生（黑方 7 步必胜）——
	{
		...
		Stones: []Stone{
			{7, 7, gomoku.Black}, {6, 8, gomoku.Black}, {8, 6, gomoku.Black}, {7, 8, gomoku.Black}, {6, 5, gomoku.Black}, {5, 7, gomoku.Black}, {7, 9, gomoku.Black}, {6, 7, gomoku.Black},
			{6, 6, gomoku.White}, {8, 7, gomoku.White}, {9, 5, gomoku.White}, {7, 6, gomoku.White}, {7, 5, gomoku.White}, {5, 8, gomoku.White}, {4, 6, gomoku.White}, {5, 5, gomoku.White},
		},
	},
	{
		ID: "6-2", Chapter: 6, Name: "绝处逢生", Difficulty: 7, ToMove: gomoku.Black,
		Stones: []Stone{
			{7, 7, gomoku.Black}, {7, 6, gomoku.Black}, {6, 7, gomoku.Black}, {8, 4, gomoku.Black}, {9, 5, gomoku.Black}, {9, 3, gomoku.Black}, {5, 3, gomoku.Black}, {9, 4, gomoku.Black}, {10, 4, gomoku.Black}, {8, 1, gomoku.Black}, {7, 3, gomoku.Black},
			{6, 6, gomoku.White}, {7, 5, gomoku.White}, {5, 7, gomoku.White}, {8, 5, gomoku.White}, {8, 6, gomoku.White}, {6, 4, gomoku.White}, {10, 3, gomoku.White}, {9, 2, gomoku.White}, {11, 4, gomoku.White}, {8, 2, gomoku.White}, {6, 2, gomoku.White},
		},
	},
	{
		ID: "6-3", Chapter: 6, Name: "绝处逢生", Difficulty: 7, ToMove: gomoku.Black,
		Stones: []Stone{
			{7, 7, gomoku.Black}, {7, 6, gomoku.Black}, {6, 7, gomoku.Black}, {8, 4, gomoku.Black}, {9, 5, gomoku.Black}, {9, 3, gomoku.Black}, {5, 3, gomoku.Black}, {9, 4, gomoku.Black}, {10, 4, gomoku.Black}, {8, 1, gomoku.Black}, {7, 3, gomoku.Black}, {4, 4, gomoku.Black},
			{6, 6, gomoku.White}, {7, 5, gomoku.White}, {5, 7, gomoku.White}, {8, 5, gomoku.White}, {8, 6, gomoku.White}, {6, 4, gomoku.White}, {10, 3, gomoku.White}, {9, 2, gomoku.White}, {11, 4, gomoku.White}, {8, 2, gomoku.White}, {6, 2, gomoku.White}, {6, 1, gomoku.White},
		},
	},
	{
		ID: "6-4", Chapter: 6, Name: "绝处逢生", Difficulty: 7, ToMove: gomoku.Black,
		Stones: []Stone{
			{7, 7, gomoku.Black}, {7, 5, gomoku.Black}, {8, 6, gomoku.Black}, {6, 4, gomoku.Black}, {5, 3, gomoku.Black}, {4, 8, gomoku.Black}, {8, 7, gomoku.Black}, {6, 8, gomoku.Black}, {8, 5, gomoku.Black}, {6, 9, gomoku.Black}, {5, 6, gomoku.Black}, {4, 3, gomoku.Black},
			{6, 6, gomoku.White}, {7, 6, gomoku.White}, {6, 5, gomoku.White}, {5, 7, gomoku.White}, {4, 2, gomoku.White}, {5, 4, gomoku.White}, {9, 7, gomoku.White}, {5, 9, gomoku.White}, {8, 8, gomoku.White}, {5, 8, gomoku.White}, {4, 4, gomoku.White}, {3, 3, gomoku.White},
		},
	},
}
