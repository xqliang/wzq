...
// 三档人机难度配置：奖章/描述/胜利金币奖励，用于古风卡片展示。
const LEVELS = [
  { lv: 1, name: '普通练习', cost: 0, medal: 'medal_ji', desc: '轻松热身，稳扎稳打', reward: 20 },
  { lv: 2, name: '中等', cost: 50, medal: 'medal_duan', desc: '攻守兼备，略有挑战', reward: 75 },
  { lv: 3, name: '高级', cost: 100, medal: 'medal_master', desc: '棋力精进，全力应战', reward: 150 },
]
      ...
      <div className="level-list">
        {LEVELS.map((l) => {
          ...
          return (
            ...
            >
              <img className="level-medal" src={img(`${l.medal}`)} alt="" />
